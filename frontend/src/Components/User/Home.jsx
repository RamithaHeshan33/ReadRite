...
import Navbar from '../Navbar/UserAfterLogin'
    ...
    <Navbar />
        ...
        <div className="flex h-150 mt-5 ml-20 mr-20 items-center">
            <div className="left">
                ...
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-5 ml-10 mr-5 cursor-pointer' onClick={() => navigate('/user/rate')}>Rate Book</button>
            </div>
